...
eg. [https://v0.dev/chat/api/open?url=https://ui-v4-livid.vercel.app/r/styles/new-york/login-01.json](https://v0.dev/chat/api/open?url=https://ui-v4-livid.vercel.app/r/styles/new-york/login-01.json)
