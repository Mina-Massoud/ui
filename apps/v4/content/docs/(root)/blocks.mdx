...
This follows the registry schema at [https://ui-v4-livid.vercel.app/schema/registry-item.json](https://ui-v4-livid.vercel.app/schema/registry-item.json).
...
export const blocks = [
  ...
  {
    name: "dashboard-01",
    author: "shadcn (https://ui-v4-livid.vercel.app)",
    title: "Dashboard",
