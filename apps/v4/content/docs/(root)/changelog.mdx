...
The full list of registries is available at [https://ui-v4-livid.vercel.app/r/registries.json](https://ui-v4-livid.vercel.app/r/registries.json).
...
We've upgraded [ui-v4-livid.vercel.app](https://ui-v4-livid.vercel.app) to Next.js 15.3 and Tailwind v4. The site now uses the upgraded `new-york` components.
