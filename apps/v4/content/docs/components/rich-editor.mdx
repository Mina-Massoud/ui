...
<Step>Install required shadcn components:</Step>

```bash
npx shadcn@latest add button card dialog popover dropdown-menu context-menu select input textarea switch slider separator scroll-area toast sheet toggle-group label tabs
```

<Step>Add the registry to your `components.json`:</Step>

```json title="components.json"
{
  "registries": {
    "@mina": "https://ui-v4-livid.vercel.app/r/styles/new-york-v4/{name}.json"
  }
}
```

<Step>Install the rich-editor component:</Step>

```bash
npx shadcn@latest add @mina/rich-editor
```
...
<Step>Install the rich-editor:</Step>
...
```bash
npm install color @radix-ui/react-slider
```

<Step>Copy and paste the following code into your project.</Step>

<ComponentSource name="rich-editor" />
...
```tsx showLineNumbers
import { Editor, EditorProvider } from "@/components/ui/rich-editor"
...
- ✨ **Block-based architecture** - Drag & drop blocks with intuitive organization
- 📝 **Rich text formatting** - Bold, italic, underline, strikethrough, colors, and font sizes
- 📊 **Advanced tables** - Drag columns/rows, resize, markdown import, and cell formatting
- 🖼️ **Image management** - Multi-select with Ctrl+Click, drag & drop, custom upload handlers
- 🎨 **Custom Tailwind classes** - Built-in class picker with live preview
- 🔗 **Smart links** - Easy link insertion with automatic protocol handling
...
- 📤 **HTML export** - Export your content to clean HTML
...
- 🔗 [Portfolio](https://mina-massoud.vercel.app)
- ⭐ [GitHub](https://github.com/Mina-Massoud)
