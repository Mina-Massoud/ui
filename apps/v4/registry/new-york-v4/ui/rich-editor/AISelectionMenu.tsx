...
const stylePresets: PresetAction[] = [
  {
    ...
    prompt:
      "Add **bold** to the most important words/phrases. Keep text otherwise identical.",
    styled: true,
  },
  {
    label: "Add emphasis",
    ...
    prompt:
      "Add **bold** and *italic* to emphasize key concepts. Keep text otherwise identical.",
    styled: true,
  },
  {
    label: "Code terms",
    ...
    prompt:
      "Wrap technical terms, function names, and code references in `backticks`. Keep text otherwise identical.",
    styled: true,
  },
]
  ...
  if (menuState === "idle") {
    return (
      <div className="border-border bg-background/60 dark:bg-background/40 w-[280px] border shadow-2xl backdrop-blur-xl backdrop-saturate-150">
        ...
        {/* Rewrite presets */}
        <div className="py-1">
          <p className="text-muted-foreground/50 px-3 pt-2 pb-1 text-[10px] tracking-wider uppercase">
            Rewrite
          </p>
