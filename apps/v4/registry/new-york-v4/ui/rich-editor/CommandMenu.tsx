        ...
        fileInput.onchange = async (e) => {
          ...
          try {
            ...
            if (onUploadVideo) {
              ...
              throw new Error(
                "Video upload requires a custom handler. Pass onUploadVideo prop to the Editor component."
              )
            }
            ...
            {showAICommand && (
              <CommandGroup heading="AI">
                <CommandItem
                  ...
                  className={`flex cursor-pointer items-start gap-3 px-3 py-2 ${selectedIndex === 0 ? "bg-accent" : ""} `}
                >
            ...
            <CommandGroup heading="Turn into">
              {filteredCommands.map((command, index) => (
                <CommandItem
                  ...
                  className={`flex cursor-pointer items-start gap-3 px-3 py-2 ${index + (showAICommand ? 1 : 0) === selectedIndex ? "bg-accent" : ""} `}
                >
